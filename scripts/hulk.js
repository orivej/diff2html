 ...
 *  Copyright 2016 Rodrigo Fernandes (@rtfpessoa).
...
switch (options.wrapper) {
  ...
  case "node":
    ...
    console.log(templates.join('\n'));
    console.log('module.exports = ' + variableName + ';');
    console.log('global.' + variableName + ' = ' + variableName + ';');
    console.log('})();');
    break;
  default:
    console.log('if (!!!' + variableName + ') var ' + variableName + ' = {};');
    console.log(templates.join('\n'));
}
